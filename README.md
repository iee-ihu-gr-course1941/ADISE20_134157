...
=================
   ...
   * [Περιγραφή API](#περιγραφή-api)
      * [Methods](#methods)
         ...
         * [Piece](#piece)
            * [Ανάγνωση Θέσης/Πουλιού](#ανάγνωση-θέσης-πουλιού)
            * [Μεταβολή Θέσης Πουλιού](#μεταβολή-θέσης-πουλιού)
         * [Player](#player)
...
- Κάντε clone το project σε κάποιον φάκελο με την εντολή
``` bash
$ git clone https://github.com/iee-ihu-gr-course1941/ADISE20_134157.git
```
- Βεβαιωθείτε ότι ο φάκελος είναι προσβάσιμος από τον Apache Server. Πιθανόν να χρειαστεί να καθορίσετε τις παρακάτω ρυθμίσεις.

- Θα πρέπει να φτιάξετε το αρχείο lib/config_local.php το οποίο να περιέχει τα user & password του server σας:
...
Επιστρέφει τα στοιχεία από το [Board](https://github.com/iee-ihu-gr-course1941/ADISE20_134157#board) με συντεταγμένες x, y. Περιλαμβάνει το χρώμα του πουλιού και τον τύπο.
...
| piece_color         | To χρώμα του πουλιού  | 'B','W', null |
| piece         | To πούλι που υπάρχει στο τετράγωνο  | 1..15 |
| occupied_by | Το πούλι που έχει <<πλακώσει>> άλλο πούλι | 1..15, null |
| moves         | Πίνακας με τα δυνατά τετράγωνα (x,y) που μπορεί να μετακινηθεί το τρέχον πούλι. Αν αυτό δεν υπάρχει ή δεν έχει κάνει login ο χρήστης ή δεν έχει ξεκινήσει το παιχνίδι ή αν δεν υπάρχουν κινήσεις, τότε το πεδίο δεν υπάρχει.  |  |
...
| dice1  | Ο αριθμός του πρώτου ζαριού | 1..6|
| dice2  | Ο αριθμός του δεύτερου ζαριού | 1..6|
